...
final class AnuToLmsCommands extends DrushCommands {
   ...
   */
  #[CLI\Command(name: 'anu-to-lms:repair-group3-schema-repository', aliases: ['atlrg3sr'])]
  #[CLI\Usage(
    name: 'drush anu-to-lms:repair-group3-schema-repository',
    description: 'Copy stale group_content installed field definitions to group_relationship before Group update 10305.',
  )]
  public function repairGroup3SchemaRepository(): void {
